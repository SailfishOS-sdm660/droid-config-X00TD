# DisplayName: Jolla x00td/@ARCH@ (release) 1
...
repo --name=adaptation-common-x00td-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation-community-common-x00td-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/x00td
